...
<div class="container">
    ...
    <div class="row">
        <div class="col s6 m6 l6 inline">
            <span>({{ $colors->count()}} colors) </span>
            <!-- Modal Trigger -->
           <a class="waves-effect waves-light btn modal-trigger" href="#color-modal">Add</a>
            ...
            <table class="responsive-table center-align">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="waves-effect waves-light btn-flat modal-trigger" href="#color-modal">Edit</a>
...
{{-- add role modal --}}
  ...
  <div id="color-modal" class="modal">
    <div class="modal-content">
        <h4 class="center">Create Color detail</h4>
    <form action=" {{route('colors.save')}} " method="POST">
      ...
      <div class="input-field col s12">
        <textarea id="textarea1" name="description" class="materialize-textarea" placeholder="color descriptional" ></textarea>
      </div>
